...
| [Configuration](configuration.md) | Complete env/runtime catalog, authority order, privacy, OTLP |
| [Portal](portal.md) | Admin UI — every `/console` page with screenshots |
...
- **Full admin portal** at `/console/login` — Today / Quality / Routing / Control hubs, template studio, Parameters, data browser, AI advisor, import/export/restore
...
- Explainable `ModelResolution` on every completion (`resolution_reason`, requested alias, semantic route)
